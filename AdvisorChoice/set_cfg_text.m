...
cfg.instr.estimated_obsacc.ask.text =  'Enter a number between 0 and 100 and press Enter:';
cfg.instr.estimated_obsacc.ask.padding = 10;
cfg.instr.estimated_obsacc.ask.y = Sc.rect(4) * .8;
